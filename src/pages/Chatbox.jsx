...
const Chatbox = () => {
    ...
    useEffect(() => {
        setCurrentUser(localStorage.getItem(process.env.REACT_APP_KEY));
        if(currentUser) {
            socket.current = io.connect("http://localhost:3001");
            socket.current.emit("add_user", currentUser);
        }
    ...
    // Send message: store in DB & emit via socket for online user
            ...
            <Breakpoint xsmall>
                <div className="chatbox-body-xsmall chatbox-body">
                    ...
                    <div className="chat-bottom chat-bottom-xsmall">
                        <input className="chatbox-bottom chatbox-bottom-xsmall" placeholder="Say something..." name="sentMessage" value={sentMessage} onChange={(e) => handleChange(e)} />
        ...
        <Breakpoint small>
            <div className="chatbox-body chatbox-body-small">
                ...
                <div className="chat-bottom">
                    <input className="chatbox-bottom" placeholder="Say something..." name="sentMessage" value={sentMessage} onChange={(e) => handleChange(e)} />
        ...
        <Breakpoint large>
            <div className="chatbox-body chatbox-body-large">
                ...
                <div className="chat-bottom chat-bottom-large">
                    <input className="chatbox-bottom chatbox-bottom-large" placeholder="Say something..." name="sentMessage" value={sentMessage} onChange={(e) => handleChange(e)} />
                    <button className="btn-send" onClick={sendMessage}>Send</button>
        ...
        <Breakpoint xlarge>
            <div className="chatbox-body">
                ...
                <div className="chat-bottom chat-bottom-xlarge">
                    <input className="chatbox-bottom chatbox-bottom-xlarge" placeholder="Say something..." name="sentMessage" onChange={(e) => handleChange(e)} />
